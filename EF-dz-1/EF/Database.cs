...
static class Database
{
   ...
   public static void AddCar(Car car, string connectionString)
    ...
    public static void RemoveCar(int Id, string connectionString)
    {
        ...
        {
            connection.Open();
            connection.Execute(commandString, new { CarId = Id });
        }

    }

    public static void UpdateCar(int Id,decimal Price, string connectionString)
    {
        ...
        {
            connection.Open();
            connection.Execute(commandString, new { NewPrice = Price, CarId = Id });
